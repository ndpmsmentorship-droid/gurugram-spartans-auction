...
export const SQUAD_RULES = {
  ...
  benchSize: 7, // bought beyond the XIII (small cards)
  maxSquad: 20, // squadSize + benchSize
  budget: 350000,
} as const;
...
export const RETAINED: RetainedPlayer[] = [
  ...
  },
  {
    ...
    "isCaptain": false,
    "isKeeper": true,
    "tagline": "Keeper · top-order batsman",
    "cost": 6000,
    "photo": "https://media.cricheroes.in/user_profile/1782204275623_yPfokkNbBL4s.jpeg?width=3840&quality=75&format=auto",
