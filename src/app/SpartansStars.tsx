...
export default function SpartansStars({ className = "" }: { className?: string }) {
  return (
    <span
      className={`inline-flex items-center gap-[1px] align-middle ${className}`}
      aria-label="Four-time trophy winners: two-time champions, two-time runners-up"
      title="4× trophy winners — 2× champions, 2× runners-up"
    >
